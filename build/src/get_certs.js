...
const getCertByID = (orgId_1, keyId_1, ...args_1) =>
  tslib_1.__awaiter(void 0, [orgId_1, keyId_1, ...args_1], void 0, function* (orgId, keyId, path = filePath) {
    try {
